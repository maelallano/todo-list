const FlagSVG = () => (
  ...
  >
    ...
    >
      ...
      />
      <path
        d="M 16.917 90 c -1.104 0 -2 -0.896 -2 -2 V 2 c 0 -1.104 0.896 -2 2 -2 s 2 0.896 2 2 v 86 C 18.917 89.104 18.021 90 16.917 90 z"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
      ...
      />
      <path
        d="M 22.021 90 H 11.814 c -1.104 0 -2 -0.896 -2 -2 s 0.896 -2 2 -2 h 10.207 c 1.104 0 2 0.896 2 2 S 23.125 90 22.021 90 z"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
